...
-export([ create/1 %% store the configs and initialize the instance
        , create/2 %% dryrun the creation
        , update/1 %% update the configs, terminate the old instance and initialize the new one
        , remove/1 %% remove the configs and terminate the instance
        , call/2   %% call the instance
        , initialize/1 %% initialize the instance
        , terminate/1 %% terminate the instance
        , reinitialize/1 %% terminate the instance and initialize it again
        ]).
